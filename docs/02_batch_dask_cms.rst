...
Instructions
================
* Before you start: Make sure you have an active CMS LPC account. For instructions on how to obtain one please go to the LPC computing `website <https://uscms.org/uscms_at_work/physics/computing/getstarted/getaccount_fermilab.shtml>`_.
* Login to EAF Jupyterhub at `https://analytics-hub.fnal.gov <https://analytics-hub.fnal.gov>`_
